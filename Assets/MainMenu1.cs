...
public class MainMenu1 : MonoBehaviour
{
  ...
  */
                ...
                if (GUI.Toggle(new Rect(1.5f * scrW, 3.5f * scrH, 2f * scrW, 0.5f * scrH), res1, "1024 x 576"))//if this toggle is pressed
                ...
                if (GUI.Toggle(new Rect(1.5f * scrW, 4f * scrH, 2f * scrW, 0.5f * scrH), res2, "1152 x 648"))//if this toggle is pressed
                ...
                if (GUI.Toggle(new Rect(1.5f * scrW, 4.5f * scrH, 2 * scrW, 0.5f * scrH), res3, "1280 x 720"))//if this toggle is pressed
                ...
                if (GUI.Toggle(new Rect(1.5f * scrW, 5f * scrH, 2f * scrW, 0.5f * scrH), res4, "1366 x 768"))//if this toggle is pressed
                ...
                if (GUI.Toggle(new Rect(1.5f * scrW, 5.5f * scrH, 2f * scrW, 0.5f * scrH), res5, "1600 x 900"))//if this toggle is pressed
                ...
                if (GUI.Toggle(new Rect(1.5f * scrW, 6f * scrH, 2 * scrW, 0.5f * scrH), res6, "1920 x 1080"))//if this toggle is pressed
                ...
                if (GUI.Toggle(new Rect(1.5f * scrW, 6.5f * scrH, 2f * scrW, 0.5f * scrH), res7, "2560 x 1440"))//if this toggle is pressed
                ...
                if (GUI.Toggle(new Rect(1.5f * scrW, 7f * scrH, 2f * scrW, 0.5f * scrH), res8, "3840 x 2160"))//if this toggle is pressed
